#!/usr/bin/env python3
"""
Simple Amazon Nova Pro Chat Application
=======================================
This is a beginner-friendly application to chat with Amazon Nova Pro on AWS Bedrock.
...
3. Run this file: python simple_nova_pro_chat.py
"""
...
# The exact name of the Nova Pro model we want to use
# This is like choosing which AI assistant to talk to
MODEL_ID = "arn:aws:bedrock:us-east-1:851725170841:provisioned-model/fg08spp4xhp0"
...
# =============================================================================
# CHAT SECTION - Functions to talk to Amazon Nova Pro
# =============================================================================

def send_message_to_nova(bedrock_client, user_message):
    """
    This function sends your message to Amazon Nova Pro and gets the response.
...
def main():
    ...
    print("=" * 60)
    print("Welcome to Amazon Nova Pro Chat!")
    print("=" * 60)
