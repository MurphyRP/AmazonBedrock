#!/usr/bin/env python3
"""
Simple Llama 4 Chat Application
==============================
This is a beginner-friendly application to chat with Llama 4 on AWS Bedrock.
...
3. Run this file: python simple_llama4_chat.py
"""
...
# The exact name of the Llama 4 model we want to use
...
# =============================================================================
# CHAT SECTION - Functions to talk to Llama 4
# =============================================================================

def send_message_to_llama(bedrock_client, user_message):
    """
    This function sends your message to Llama 4 and gets the response.
...
def main():
    ...
    while True:
        ...
        response = send_message_to_llama(bedrock, user_input)
